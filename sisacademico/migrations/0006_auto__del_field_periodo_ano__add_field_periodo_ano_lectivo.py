...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Periodo.ano'
        db.delete_column(u'sisacademico_periodo', 'ano')

        # Adding field 'Periodo.ano_lectivo'
        db.add_column(u'sisacademico_periodo', 'ano_lectivo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Periodo.ano'
        db.add_column(u'sisacademico_periodo', 'ano',
                      self.gf('django.db.models.fields.IntegerField')(default=None),
                      keep_default=False)

        # Deleting field 'Periodo.ano_lectivo'
        db.delete_column(u'sisacademico_periodo', 'ano_lectivo')
    ...
    models = {
        ...
        u'sisacademico.periodo': {
            ...
            'ano_lectivo': ('django.db.models.fields.CharField', [], {'max_length': '150', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
