...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Clase_Profesor'
        db.create_table(u'sisacademico_clase_profesor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profesor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sisacademico.Perfil_Profesor'], null=True, blank=True)),
            ('clase', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sisacademico.Clase'], null=True, blank=True)),
        ))
        db.send_create_signal(u'sisacademico', ['Clase_Profesor'])


    def backwards(self, orm):
        # Deleting model 'Clase_Profesor'
        db.delete_table(u'sisacademico_clase_profesor')
