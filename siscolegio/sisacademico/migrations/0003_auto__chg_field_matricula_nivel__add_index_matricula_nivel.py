...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Matricula.nivel' to match new field type.
        db.rename_column(u'sisacademico_matricula', 'nivel', 'nivel_id')
        # Changing field 'Matricula.nivel'
        db.alter_column(u'sisacademico_matricula', 'nivel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sisacademico.Nivel'], null=True))
        # Adding index on 'Matricula', fields ['nivel']
        db.create_index(u'sisacademico_matricula', ['nivel_id'])


    def backwards(self, orm):
        # Removing index on 'Matricula', fields ['nivel']
        db.delete_index(u'sisacademico_matricula', ['nivel_id'])


        # Renaming column for 'Matricula.nivel' to match new field type.
        db.rename_column(u'sisacademico_matricula', 'nivel_id', 'nivel')
        # Changing field 'Matricula.nivel'
        db.alter_column(u'sisacademico_matricula', 'nivel', self.gf('django.db.models.fields.CharField')(default=None, max_length=150))
