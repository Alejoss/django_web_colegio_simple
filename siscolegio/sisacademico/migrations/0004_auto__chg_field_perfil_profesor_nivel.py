...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Perfil_Profesor.nivel'
        db.alter_column(u'sisacademico_perfil_profesor', 'nivel_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sisacademico.Nivel'], null=True))

    def backwards(self, orm):

        # Changing field 'Perfil_Profesor.nivel'
        db.alter_column(u'sisacademico_perfil_profesor', 'nivel_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['sisacademico.Nivel']))
