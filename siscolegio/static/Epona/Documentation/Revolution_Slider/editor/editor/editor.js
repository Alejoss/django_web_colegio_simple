	...
	********************************/
	...
	jQuery('#transitselector').click(function() {
		...
		if (!ts.hasClass("opened")) {
			punchgs.TweenLite.fromTo(ts,0.2,{opacity:0,transformOrigin:"center bottom", transformPerspective:400, y:-50,rotationX:0,z:0},{opacity:1,y:0,rotationX:0,ease:Power3.easeOut})
	...
	jQuery('body').on('mouseleave','.transition-selectbox-holder.opened',function() {
				...
				var ts = jQuery('.transition-selectbox-holder');
				punchgs.TweenLite.to(ts,0.2,{opacity:0,transformOrigin:"center bottom", transformPerspective:400, y:-50,rotationX:0,z:0,ease:Power3.easeOut});
